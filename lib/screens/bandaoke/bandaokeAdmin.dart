...
class BandaokeAdmin extends StatefulWidget {
  const BandaokeAdmin({Key? key}) : super(key: key);
            ...
            children: [
              Padding(
                ...
                child: ElevatedButton(
                  ...
                  child: const Text('Next Singer'),
                  // When the Next Singer button is tapped, remove the first
                  // entry from the queue
                  onPressed: () async {
                    _database.nextSinger();
                  },
                ),
              ),
              Padding(
                ...
                child: ElevatedButton(
                  ...
                  // When the Clear Queue button is tapped, display the dialog
                  // confirmation box to double-check that the user actually
                  // wants to clear the queue
                  onPressed: () async {
                    showClearQueueAlertDialog(context);
                  },
                ),
              ),
            ],
...
// The clear queue confirmation pop-up Widget
showClearQueueAlertDialog(context) {
  final DatabaseService _database = DatabaseService();

  // If the user taps "Yes", clear the queue
  // Then close the pop-up
  Widget yesButton = TextButton(
    child: const Text("Yes"),
    onPressed: () async {
